  ...
  "inline-flex items-center gap-1 rounded-md border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // A state, not a colour. Each pair is contrast-checked in the theme.
        good: "border-good/20 bg-good-bg text-good-ink",
        warn: "border-warn/20 bg-warn-bg text-warn-ink",
        bad: "border-bad/20 bg-bad-bg text-bad-ink",
